...
function results(){
    ...
    for (i=0; i<gradeBook.length; i++){
        let output = `<strong>Subject:</strong> <em>${gradeBook[i]['subject']}</em>,<br><strong>Score:</strong> <em>${gradeBook[i]['grade']}</em>,<br><strong>Grade of Reslut:</strong> <em>${gradeBook[i]['mark']}</em><br><br><hr><br><br>`;
